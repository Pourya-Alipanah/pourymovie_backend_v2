...
public class GeminiProvider {
  ...
  public ResponseStream<GenerateContentResponse> generateResponseStream(String prompt) {
    ...
    GenerateContentConfig config =
        GenerateContentConfig.builder().safetySettings(safetySetting).build();

    return client.models.generateContentStream(appDefaults.getGeminiModelName(), prompt, config);
  }
}
